...
files = glob.glob('Comparison Periods/GTFS-RT data/Feb/Week 1/*.parquet')
...
files = glob.glob('Comparison Periods/GTFS-RT data/Feb/Week 2/*.parquet')
...
#April Week 1
files = glob.glob('Comparison Periods/GTFS-RT data/April/Week 1/*.parquet')
...
files = glob.glob('Comparison Periods/GTFS-RT data/April/Week 2/*.parquet')
...
files = glob.glob('Comparison Periods/GTFS-RT data/July/Week 1/*.parquet')
...
files = glob.glob('Comparison Periods/GTFS-RT data/July/Week 2/*.parquet')
...
files = glob.glob('Comparison Periods/GTFS-RT data/October/Week 1/*.parquet')
...
files = glob.glob('Comparison Periods/GTFS-RT data/October/Week 2/*.parquet')
